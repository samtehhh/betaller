...
class AppLocalizationsDe extends AppLocalizations {
  ...
  // ── v6 Home Screen ──
  @override String get greetingAllDone => 'Toll gemacht! 🎯';
  @override String get greetingAllDoneSub => 'Du hast die heutigen Aufgaben erledigt.';
  @override String greetingStreak30(int streak) => '$streak Tage Serie — legendäres Level.';
  @override String greetingStreak7(int streak) => '$streak Tage Serie — weiter so.';
  @override String greetingStreak3(int streak) => '$streak Tage hintereinander. Die meisten geben auf. Du nicht.';
  @override String get greetingMorning => 'Guten Morgen. Ein neuer Tag, eine neue Chance.';
  @override String get greetingAfternoon => 'Heute ist ein toller Tag, deine Serie zu starten.';
  @override String get greetingEvening => 'Aufgaben erledigen, Serie starten.';
  @override String get todayCompleted => 'Heute erledigt ✓';
  @override String get todayGoals => 'Heutige Ziele';
  @override String get challengesLabel => 'Aufgaben';
  @override String get dailyChallengesLabel => 'TÄGLICHE AUFGABEN';
  @override String get expiresTonight => 'Läuft heute Nacht ab';
  @override String get allChallengesCompleted => 'Alle erledigt ✓';
  @override String get challengesLoading => 'Neue Aufgaben werden geladen.';
  @override String get challengesLoadingTitle => 'Tägliche Aufgaben';
  @override String get behindPace => 'Du bist im Rückstand';
  @override String get growthTracking => 'Wachstumsverfolgung';
  @override String get growthEmptyFirst => 'Erfasse deine erste Größe.';
  @override String get growthEmptySecond => 'Zweite Messung eingeben, Diagramm sehen.';
  @override String get growthSectionLabel => 'WACHSTUM';
  @override String get generalPerformance => 'GESAMTLEISTUNG';
  @override String get exploreLabel => 'ENTDECKEN';
  @override String get explorePosture => 'Haltungsanalyse';
  @override String get explorePostureSub => 'Haltungsanalyse und Korrekturtipps';
  @override String get explorePhotos => 'Fortschrittsfotos';
  @override String get explorePhotosSub => 'Verfolge deine Veränderung mit Fotos';
  @override String get exploreNutrition => 'Ernährung';
  @override String get exploreNutritionSub => 'Protein-, Kalzium- und Vitaminratgeber';
  @override String get exploreHealth => 'Gesundheit';
  @override String get exploreHealthSub => 'Stress-, Koffein- und Wellness-Tracking';
  @override String get exploreRecipes => 'Wachstumsrezepte';
  @override String get exploreRecipesSub => 'Rezepte, die das Wachstum unterstützen';
  @override String get educationLabel => 'BILDUNG';
  @override String get educationTitle => 'Wissenschaft des\nGrößenwachstums';
  @override String get educationSubtitle => 'Experten-Inhalte, Forschung und Leitfäden';
  @override String get aiAnalysisLabel => 'KI-ANALYSE';
  @override String get peerCompareLabel => 'MIT GLEICHALTRIGEN VERGLEICHEN';
  @override String peerCompareText(int topPct) => 'Du bist in den Top $topPct% deiner Altersgruppe';
  // ── v6 Notifications ──
  @override String get notifWaterTitle => '💧 Vergiss nicht zu trinken!';
  @override String get notifWaterBody => 'Hast du dein Tagesziel erreicht? Trink noch ein Glas!';
  @override String get notifMorningTitle => '🌅 Guten Morgen! Trainingszeit';
  @override String get notifMorningBody => 'Mach deine Morgendehnungen! 10 Minuten für Wirbelsäule und Beine.';
  @override String get notifRoutineTitle => '🔥 Schließe deine Routinen ab!';
  @override String get notifRoutineBody => 'Überprüfe deine Routinen vor Tagesende. Serie aufbauen = Disziplin!';
  @override String get notifProteinTitle => '🥚 Proteintag!';
  @override String get notifProteinBody => 'Starte stark in die Woche! Protein bei jeder Mahlzeit.';
  @override String get notifNewWeekTitle => '✨ Neue Woche, neue Ziele!';
  @override String get notifNewWeekBody => 'Überspringe diese Woche keine Routinen. Kleine Schritte, große Wirkung!';
  @override String get notifSleepTitle => '😴 Schlafenszeit!';
  @override String get notifSleepBody => 'Wachstumshormon ist zwischen 22-2 Uhr am höchsten. Leg das Handy weg!';
  @override String get notifPostureTitle => '🧍 Haltungskontrolle!';
  @override String get notifPostureBody => 'Rücken gerade, Schultern zurück. Gute Haltung = 2-3 cm Unterschied!';
  @override String get notifVitaminDTitle => '☀️ Vitamin D Zeit!';
  @override String get notifVitaminDBody => '15 Minuten Sonne! Vitamin D fördert die Kalziumaufnahme.';
  @override String get notifMidweekTitle => '✨ Halbzeit!';
  @override String get notifMidweekBody => 'Mitte der Woche. Wachstum braucht Geduld, aber Beständigkeit gewinnt!';
  @override String get notifScreenTitle => '📵 Bildschirme aus!';
  @override String get notifScreenBody => '1 Stunde vor dem Schlafengehen keine Bildschirme. Blaues Licht blockiert Melatonin!';
  @override String get notifJumpTitle => '🦘 Sprungzeit!';
  @override String get notifJumpBody => 'Sprungübungen stimulieren die Wachstumsfugen. Versuch 3 x 20 Wiederholungen!';
  @override String get notifCalciumTitle => '🥛 Kalziumzeit!';
  @override String get notifCalciumBody => 'Trink ein Glas Milch oder Joghurt. Kalzium ist wichtig für die Knochen!';
  @override String get notifPostureCheckTitle => '🧍 Haltungskontrolle!';
  @override String get notifPostureCheckBody => 'Neige nicht den Hals beim Handyschauen! Achte auf deine Wirbelsäule.';
  @override String get notifWeekendTitle => '✨ Wochenend-Motivation';
  @override String get notifWeekendBody => 'Auch am Wochenende Routinen einhalten! Disziplin gilt jeden Tag!';
  @override String get notifWeeklyProgressTitle => '📊 Wöchentlicher Fortschritt';
  @override String get notifWeeklyProgressBody => 'Wie war deine Woche? Überprüfe dein Wachstumsdiagramm!';
  @override String get notifMeasureTitle => '📏 Wöchentliche Größenmessung!';
  @override String get notifMeasureBody => 'Miss dich und trag es ein! Morgenmessungen sind am genauesten.';
  @override String get notifEarlySleepTitle => '😴 Früh ins Bett!';
  @override String get notifEarlySleepBody => 'Morgen ist Montag! Starte die Woche mit gutem Schlaf. Mindestens 8 Stunden.';
  @override String get notifStreak3Title => '🔥 3 Tage Serie!';
  @override String get notifStreak3Body => 'Toller Start! 3 Tage hintereinander geschafft. Weiter so, schaff 7!';
  @override String get notifStreak7Title => '🏆 1 Woche Serie!';
  @override String get notifStreak7Body => 'Unglaublich! 7 Tage in Folge alle Routinen abgeschlossen!';
  @override String get notifStreak14Title => '⭐ 2 Wochen Serie!';
  @override String get notifStreak14Body => '14 Tage Disziplin! Dein Körper beginnt sich zu verändern.';
  @override String get notifStreak30Title => '👑 1 Monat Serie!';
  @override String get notifStreak30Body => '30 Tage! Du bist ein Champion! Mach weiter so!';
  @override String get notifStreak60Title => '🌟 60 Tage Serie!';
  @override String get notifStreak60Body => '60 Tage! Eine unglaubliche Leistung. Nur wenige erreichen das!';
  @override String get notifStreak100Title => '💎 100 TAGE! LEGENDÄR!';
  @override String get notifStreak100Body => '100 Tage in Folge! Du bist eine Legende geworden!';
  @override String get notifStreakRiskTitle => '⚠️ Verlier deine Serie nicht!';
  @override String notifStreakRiskBody(int streak) => 'Deine $streak-Tage-Serie ist in Gefahr! Schließe die heutigen Routinen ab.';
  // ── v6 Premium Paywall ──
  @override String get paywallStat1 => 'cm — dein Potenzial ist gesperrt';
  @override String get paywallTitle1 => 'Wie viele cm\nkannst du wachsen?';
  @override String get paywallBullet1a => 'Dein genetisches Maximum wurde berechnet, willst du es sehen?';
  @override String get paywallBullet1b => 'Wie beeinflusst dein Lebensstil dein Wachstum?';
  @override String get paywallBullet1c => 'Dein persönlicher Fahrplan wartet';
  @override String get paywallStat2 => 'deine persönliche Routine ist bereit';
  @override String get paywallTitle2 => 'Dein Plan\nist bereit';
  @override String get paywallBullet2a => 'Jeden Morgen 8 Minuten — für deine Wirbelsäule';
  @override String get paywallBullet2b => 'Schlaf, Ernährung, Wasser — alles im Blick';
  @override String get paywallBullet2c => 'Jeden Tag ein Schritt weiter, halte die Serie';
  @override String get paywallStat3 => 'Echtzeit-Fortschrittsdiagramme';
  @override String get paywallTitle3 => 'Verfolge dein\nWachstum';
  @override String get paywallBullet3a => 'Monatliche Messungen — sieh dein Wachstum selbst';
  @override String get paywallBullet3b => 'Gewinne jetzt 2 cm mit Haltungsanalyse';
  @override String get paywallBullet3c => 'Fortschrittsfotos — du wirst den Unterschied sehen';
  @override String get paywallStat4 => 'Tagesprogramm — Level aufsteigen';
  @override String get paywallTitle4 => 'Jeden Tag\nstärker';
  @override String get paywallBullet4a => 'XP verdienen, Level freischalten — Gewohnheit wird zum Spiel';
  @override String get paywallBullet4b => 'Wer sein Ziel erreichte, kam hier durch';
  @override String get paywallBullet4c => 'Starte jetzt — erste Woche kostenlos';
  @override String get paywallRestore => 'Kein früherer Kauf gefunden';
  @override String get paywallRestoreNotFound => 'Kein früherer Kauf gefunden';
  @override String get paywallRestoreLabel => 'Käufe wiederherstellen';
  @override String get paywallYearly => 'Jährlich';
  @override String get paywallBestValue => 'Bester Wert';
  @override String get paywallMonthly => 'Monatlich';
  @override String get paywallFreeTrial => '3 Tage kostenlos';
  @override String get paywallLoadError => 'Kauf konnte nicht geladen werden, versuche es erneut';
  @override String get paywallCta => 'Kostenlos testen';
  @override String get paywallCtaAlt => 'Weiter';
  @override String get paywallTrialDisclaimer => '3 Tage kostenlos · danach automatische Verlängerung · jederzeit kündbar';
  @override String get paywallYearlyDisclaimer => 'Jährliche automatische Verlängerung · jederzeit kündbar';
