...
class AppLocalizationsPt extends AppLocalizations {
  ...
  // ── v6 Home Screen ──
  @override String get greetingAllDone => 'Ótimo trabalho! 🎯';
  @override String get greetingAllDoneSub => 'Você completou as tarefas de hoje.';
  @override String greetingStreak30(int streak) => 'Sequência de $streak dias — nível lendário.';
  @override String greetingStreak7(int streak) => 'Sequência de $streak dias — continue assim.';
  @override String greetingStreak3(int streak) => '$streak dias seguidos. A maioria desiste. Você não.';
  @override String get greetingMorning => 'Bom dia. Um novo dia, uma nova chance.';
  @override String get greetingAfternoon => 'Hoje é um ótimo dia para começar sua sequência.';
  @override String get greetingEvening => 'Complete suas tarefas, inicie sua sequência.';
  @override String get todayCompleted => 'Hoje concluído ✓';
  @override String get todayGoals => 'Metas de hoje';
  @override String get challengesLabel => 'Desafios';
  @override String get dailyChallengesLabel => 'DESAFIOS DIÁRIOS';
  @override String get expiresTonight => 'Expira esta noite';
  @override String get allChallengesCompleted => 'Todos concluídos ✓';
  @override String get challengesLoading => 'Novos desafios carregando em breve.';
  @override String get challengesLoadingTitle => 'Desafios diários';
  @override String get behindPace => 'Atrasado';
  @override String get growthTracking => 'Rastreio de crescimento';
  @override String get growthEmptyFirst => 'Registre sua primeira altura.';
  @override String get growthEmptySecond => 'Adicione uma 2ª medição para ver o gráfico.';
  @override String get growthSectionLabel => 'CRESCIMENTO';
  @override String get generalPerformance => 'DESEMPENHO GERAL';
  @override String get exploreLabel => 'EXPLORAR';
  @override String get explorePosture => 'Análise postural';
  @override String get explorePostureSub => 'Análise e dicas de correção postural';
  @override String get explorePhotos => 'Fotos de progresso';
  @override String get explorePhotosSub => 'Acompanhe sua transformação com fotos';
  @override String get exploreNutrition => 'Nutrição';
  @override String get exploreNutritionSub => 'Guia de proteínas, cálcio e vitaminas';
  @override String get exploreHealth => 'Saúde';
  @override String get exploreHealthSub => 'Rastreio de estresse, cafeína e bem-estar';
  @override String get exploreRecipes => 'Receitas de crescimento';
  @override String get exploreRecipesSub => 'Receitas que apoiam o crescimento';
  @override String get educationLabel => 'EDUCAÇÃO';
  @override String get educationTitle => 'Ciência do\ncrescimento';
  @override String get educationSubtitle => 'Conteúdo especializado, pesquisas e guias';
  @override String get aiAnalysisLabel => 'ANÁLISE IA';
  @override String get peerCompareLabel => 'COMPARAR COM PARES';
  @override String peerCompareText(int topPct) => 'Você está no Top $topPct% dos seus pares';
  // ── v6 Notifications ──
  @override String get notifWaterTitle => '💧 Não esqueça de beber água!';
  @override String get notifWaterBody => 'Atingiu sua meta diária? Beba mais um copo!';
  @override String get notifMorningTitle => '🌅 Bom dia! Hora de se exercitar';
  @override String get notifMorningBody => 'Faça seus alongamentos matinais! 10 minutos para coluna e pernas.';
  @override String get notifRoutineTitle => '🔥 Complete suas rotinas!';
  @override String get notifRoutineBody => 'Verifique suas rotinas antes do dia acabar. Sequência = disciplina!';
  @override String get notifProteinTitle => '🥚 Dia de proteína!';
  @override String get notifProteinBody => 'Comece a semana forte! Proteína em cada refeição.';
  @override String get notifNewWeekTitle => '✨ Nova semana, novas metas!';
  @override String get notifNewWeekBody => 'Não pule as rotinas esta semana. Pequenos passos, grandes mudanças!';
  @override String get notifSleepTitle => '😴 Hora de dormir!';
  @override String get notifSleepBody => 'O hormônio do crescimento atinge o pico entre 22h-2h. Largue o celular!';
  @override String get notifPostureTitle => '🧍 Controle de postura!';
  @override String get notifPostureBody => 'Costas retas, ombros para trás. Boa postura = 2-3 cm de diferença!';
  @override String get notifVitaminDTitle => '☀️ Vitamina D!';
  @override String get notifVitaminDBody => '15 minutos de sol! A vitamina D melhora a absorção de cálcio.';
  @override String get notifMidweekTitle => '✨ Metade da semana!';
  @override String get notifMidweekBody => 'Meio da semana. Crescimento exige paciência. Continue!';
  @override String get notifScreenTitle => '📵 Desligue as telas!';
  @override String get notifScreenBody => 'Sem telas 1 hora antes de dormir. Luz azul bloqueia a melatonina!';
  @override String get notifJumpTitle => '🦘 Hora de pular!';
  @override String get notifJumpBody => 'Exercícios de salto estimulam as placas de crescimento. Tente 3 x 20!';
  @override String get notifCalciumTitle => '🥛 Cálcio!';
  @override String get notifCalciumBody => 'Um copo de leite ou iogurte. O cálcio é essencial para os ossos!';
  @override String get notifPostureCheckTitle => '🧍 Controle de postura!';
  @override String get notifPostureCheckBody => 'Não incline o pescoço olhando o celular! Sente e ande ereto.';
  @override String get notifWeekendTitle => '✨ Motivação de fim de semana';
  @override String get notifWeekendBody => 'Não pule rotinas no fim de semana! Disciplina vale todo dia!';
  @override String get notifWeeklyProgressTitle => '📊 Progresso semanal';
  @override String get notifWeeklyProgressBody => 'Como foi sua semana? Confira seu gráfico de crescimento!';
  @override String get notifMeasureTitle => '📏 Medição semanal!';
  @override String get notifMeasureBody => 'Meça-se e registre! Medições matinais são mais precisas.';
  @override String get notifEarlySleepTitle => '😴 Durma cedo!';
  @override String get notifEarlySleepBody => 'Amanhã é segunda! Comece forte com um bom sono. Pelo menos 8 horas.';
  @override String get notifStreak3Title => '🔥 Sequência de 3 dias!';
  @override String get notifStreak3Body => 'Ótimo começo! 3 dias seguidos. Continue até 7!';
  @override String get notifStreak7Title => '🏆 Sequência de 1 semana!';
  @override String get notifStreak7Body => 'Incrível! 7 dias consecutivos de rotinas completas!';
  @override String get notifStreak14Title => '⭐ Sequência de 2 semanas!';
  @override String get notifStreak14Body => '14 dias de disciplina! Seu corpo está começando a mudar.';
  @override String get notifStreak30Title => '👑 Sequência de 1 mês!';
  @override String get notifStreak30Body => '30 dias! Você é um campeão! Continue assim!';
  @override String get notifStreak60Title => '🌟 Sequência de 60 dias!';
  @override String get notifStreak60Body => '60 dias! Uma conquista incrível. Pouquíssimos conseguem!';
  @override String get notifStreak100Title => '💎 100 DIAS! LENDÁRIO!';
  @override String get notifStreak100Body => '100 dias seguidos! Você se tornou uma lenda!';
  @override String get notifStreakRiskTitle => '⚠️ Não perca sua sequência!';
  @override String notifStreakRiskBody(int streak) => 'Sua sequência de $streak dias está em risco! Complete as rotinas de hoje.';
  // ── v6 Premium Paywall ──
  @override String get paywallStat1 => 'cm — seu potencial está bloqueado';
  @override String get paywallTitle1 => 'Quantos cm você\npode crescer?';
  @override String get paywallBullet1a => 'Seu teto genético foi calculado, quer ver?';
  @override String get paywallBullet1b => 'Como seu estilo de vida afeta seu crescimento?';
  @override String get paywallBullet1c => 'Seu roteiro personalizado te espera';
  @override String get paywallStat2 => 'sua rotina personalizada está pronta';
  @override String get paywallTitle2 => 'Seu plano\nestá pronto';
  @override String get paywallBullet2a => '8 minutos toda manhã — projetado para sua coluna';
  @override String get paywallBullet2b => 'Sono, nutrição, água — tudo monitorado';
  @override String get paywallBullet2c => 'Um passo a mais todo dia, não quebre a sequência';
  @override String get paywallStat3 => 'gráficos de progresso em tempo real';
  @override String get paywallTitle3 => 'Acompanhe seu\ncrescimento';
  @override String get paywallBullet3a => 'Medições mensais — veja seu crescimento com seus olhos';
  @override String get paywallBullet3b => 'Ganhe 2 cm agora com análise postural';
  @override String get paywallBullet3c => 'Fotos de progresso — você verá a diferença';
  @override String get paywallStat4 => 'programa diário — subindo de nível';
  @override String get paywallTitle4 => 'Mais forte\na cada dia';
  @override String get paywallBullet4a => 'Ganhe XP, desbloqueie níveis — hábitos viram um jogo';
  @override String get paywallBullet4b => 'Quem atingiu a meta passou por aqui';
  @override String get paywallBullet4c => 'Comece agora — primeira semana grátis';
  @override String get paywallRestore => 'Nenhuma compra anterior encontrada';
  @override String get paywallRestoreNotFound => 'Nenhuma compra anterior encontrada';
  @override String get paywallRestoreLabel => 'Restaurar compras';
  @override String get paywallYearly => 'Anual';
  @override String get paywallBestValue => 'Melhor valor';
  @override String get paywallMonthly => 'Mensal';
  @override String get paywallFreeTrial => '3 dias grátis';
  @override String get paywallLoadError => 'Não foi possível carregar, tente novamente';
  @override String get paywallCta => 'Teste grátis';
  @override String get paywallCtaAlt => 'Continuar';
  @override String get paywallTrialDisclaimer => '3 dias grátis · renovação auto · cancele a qualquer momento';
  @override String get paywallYearlyDisclaimer => 'Renovação anual auto · cancele a qualquer momento';
